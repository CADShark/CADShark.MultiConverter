...
internal class SwFileSaveWarning
{
    internal static string ParseSaveError(swFileSaveWarning_e warning)
    {
        ...
        if (warning.HasFlag(swFileSaveWarning_e.swFileSaveWarning_NeedsRebuild)) warnings.Add("Needs Rebuild");
        if (warning.HasFlag(swFileSaveWarning_e.swFileSaveWarning_OpenedViewOnly)) warnings.Add("Opened View Only");
        if (warning.HasFlag(swFileSaveWarning_e.swFileSaveWarning_RebuildError)) warnings.Add("Rebuild Error");
        if (warning.HasFlag(swFileSaveWarning_e.swFileSaveWarning_ViewsNeedUpdate)) warnings.Add("Views Need Update");
        if (warning.HasFlag(swFileSaveWarning_e.swFileSaveWarning_XmlInvalid)) warnings.Add("Xml Invalid");
